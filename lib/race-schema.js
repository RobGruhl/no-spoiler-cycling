...
// Absent = scheduled. 'cancelled' covers postponed-to-next-year editions too —
// the calendar question is "will this happen this season", and statusNote
// carries the nuance ("postponed to September 2027").
const STATUS_ENUM = new Set(['cancelled']);
...
export function validateRace(race, { strict = false } = {}) {
  ...
  enumCheck(checks, 'status', race.status, STATUS_ENUM, 'fail');
...
export const ENUMS = {
  GENDER_ENUM, DISCIPLINE_ENUM, FORMAT_ENUM, TERRAIN_ENUM, STAGE_TYPE_ENUM, STATUS_ENUM,
};
